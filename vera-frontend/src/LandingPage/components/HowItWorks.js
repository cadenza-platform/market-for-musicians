    ...
    <Container fluid className="howitworks-container" id="how-it-works">
      <Row className="flex-column flex-md-row">
        ...
        <Col className="howitworks-text-body">
          <i>
            With Vera, artists can distribute their music in the form of digital
            vinyl records to the public. You can follow the growth of your
            favorite artists by purchasing copies of these records.
          </i>
        </Col>
      </Row>
      <br />
