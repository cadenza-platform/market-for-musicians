...
function ArtistFeatures() {
  return (
    <Container
      fluid
      className="artist-features-container align-content-start"
      id="features"
    >
      ...
      <Row className="artist-feature-row">
        ...
        <Col className="artist-feature-description">
          ...
          <p className="artist-feature-body">
            ...
            bringing in a new source of income to keep the music flowing.
          </p>
        </Col>
      </Row>
      <Row className="artist-feature-row">
      ...
      <Row className="artist-feature-row">
        ...
        <Col className="artist-feature-description">
          <h2 className="artist-feature-title">Monetization</h2>
          <p className="artist-feature-body">
      ...
      <Row className="artist-feature-row">
        ...
        <Col className="artist-feature-description">
          <h2 className="artist-feature-title">Low Environmental Impact</h2>
          <p className="artist-feature-body">
