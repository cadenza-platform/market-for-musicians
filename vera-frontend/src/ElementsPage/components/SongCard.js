    ...
    return (
        <Card className="songcard">
            ...
            <Card.Body>
                <Row>
                    <Col>
                        <Card.Title className="songcard-title">{props.song.title}</Card.Title>
                    </Col>
                ...
                <Row>
                    <Col>
                        <Card.Text className="songcard-artist">{props.song.artist}</Card.Text>
                    </Col>
                    <Col>
                        <Card.Text className="songcard-listens">{props.song.listens} Listens</Card.Text>
                    </Col>
                </Row>
            </Card.Body>
